  ...
  module Schemas
    class PPIU
      ...
      swagger_schema :PaymentAddress do
        ...
        property :address_two, type: :string, example: 'Second street address line'
        property :address_three, type: :string, example: 'Third street address line'
        property :city, type: :string, example: 'AdHocville'
        property :state_code, type: :string, example: 'OR'
        property :country_name, type: :string, example: 'USA'
        property :military_post_office_type_code, type: :string, example: 'Military PO'
        property :military_state_code, type: :string, example: 'AP'
        property :zip_code, type: :string, example: '12345'
        property :zip_suffix, type: :string, example: '6789'
        property :type, type: :string, example: 'Domestic'
      end
